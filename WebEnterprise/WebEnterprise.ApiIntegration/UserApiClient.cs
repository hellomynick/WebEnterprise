...
namespace WebEnterprise.ApiIntegration
{
    public class UserApiClient : IUserApiClient
    {
        ...
        public async Task<ApiResult<List<UserVm>>> GetAll()
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                List<UserVm> myDeserializedObjList = (List<UserVm>)JsonConvert.DeserializeObject(body, typeof(List<UserVm>));
                return new ApiSuccessResult<List<UserVm>>(myDeserializedObjList);
            }
            return JsonConvert.DeserializeObject<ApiErrorResult<List<UserVm>>>(body);
        }
