...
namespace WebEnterprise.Application.System.Users
{
    public class UserService : IUserService
    {
        ...
        public UserService(UserManager<User> userManager, SignInManager<User> signInManager, RoleManager<GroupUser> roleManager, IConfiguration config)
        {
        ...
        public async Task<ApiResult<bool>> Register(RegisterRequest request)
        {
            ...
            {
                return new ApiErrorResult<bool>("Emai already exists");
            }
